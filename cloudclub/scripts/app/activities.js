...
app.Activities = (function () {
    ...
    var show = function (e) {
        ...
        app.Activities.activities._filter.filters[1].value = thePartner;
        app.Activities.activities.read(function () {
    ...
    var activitiesModel = (function () {
        var activityModel = {
            ...
            User: function () {
                ...
                if (userId === undefined) {
                    app.showShortTop("userID is null");
        ...
        var activitiesDataSource = new kendo.data.DataSource({
            ...
            filter: {
                ...
                filters: [
                   ...
                   {
                       logic: 'and', filters: [
                           { field: "Title", operator: "eq", value: thePartner },
